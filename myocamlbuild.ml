(* OASIS_START *)
(* DO NOT EDIT (digest: b61228f62f0d298710f45379a0ce97f8) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_library_signpost_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_signpost_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_signpost_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_signpost_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_signpost_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_signpost_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);
          (["oasis_library_ace_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@f@p@u"])]);

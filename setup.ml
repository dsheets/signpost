...
(* OASIS_START *)
(* DO NOT EDIT (digest: 374307847e9678c3bd96af9df514b274) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("dnscurve.lwt", None)];
                   ...
                   {
                      lib_modules = ["Control_protocol"];
                      lib_pack = false;
                      lib_internal_modules = ["Base16"; "Version"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "signpost";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("sodium", None);
                           FindlibPackage ("dns", None);
                           FindlibPackage ("dnscurve", None);
                           InternalLibrary "signpost"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      ...
                      },
                   {
                      ...
                      lib_findlib_parent = Some "signpost";
                      lib_findlib_name = Some "ace";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "spkeygen.ml"; });
               Executable
                 ({
                     cs_name = "spaced";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "spaced.ml"; });
               Executable
                 ({
                     cs_name = "spbased";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "spbased.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\222\161\133\225\196\021\191\222\2046\233\240o\223\234\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
